...
#ifndef SDL2_POWERVR_GE8300 //for PowerVR GE8300
    data->native_display.width = 480;//vinfo.xres;
    data->native_display.height = 640;//vinfo.yres;
#endif
